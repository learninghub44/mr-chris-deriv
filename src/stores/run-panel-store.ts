...
export default class RunPanelStore {
    ...
    showRealAccountDialog = () => {
        ...
        this.dialog_options = {
            title: localize("Mr Chris isn't quite ready for real accounts"),
            message: localize('Please switch to your demo account to run your Mr Chris.'),
        };
        this.is_dialog_open = true;
    };
    ...
    showIncompatibleStrategyDialog = () => {
        ...
        this.dialog_options = {
            ...
            message: localize('This strategy is currently not compatible with Mr Chris.'),
        };
        this.is_dialog_open = true;
    };
