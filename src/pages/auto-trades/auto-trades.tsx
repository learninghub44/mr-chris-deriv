...
const AutoTrades = observer(() => {
    ...
    const handleTick = useCallback(
        (symbol: string, tick: any) => {
            ...
            if (isRecoveringData) setIsRecoveringData(false);
        ...
        [getActiveDigitBarrier, isPatternDigit, isRecoveringData, refreshDisplays, tryExecuteSignal]
    );
    ...
    }, [handleCandle, handleTick, isRecoveringData, selectedMarkets, show_auto]);
                    ...
                    <div className='auto-trades-page__body'>
                        ...
                        <div className='auto-trades-page__sidebar'>
                            ...
                            <div className='auto-trades-card'>
                                ...
                                {/* Market selection */}
                                <div className='auto-trades-config__group auto-trades-market-picker'>
                                    <div className='auto-trades-market-picker__header'>
                                        <p className='auto-trades-config__group-label'>Markets</p>
                                        <span>
                                            {selectedMarketSymbols.length}/{AUTO_MARKETS.length} selected
                                        </span>
                                    </div>
                                    <div className='auto-trades-market-picker__actions'>
                                        <button type='button' onClick={handleSelectAllMarkets} disabled={isRunning}>
                                            Select all
                                        </button>
                                        <button type='button' onClick={handleClearMarkets} disabled={isRunning}>
                                            Clear
                                        </button>
                                    </div>
                                    <div className='auto-trades-market-picker__grid'>
                                        {AUTO_MARKETS.map(market => (
                                            <label key={market.symbol} className='auto-trades-market-picker__option'>
                                                <input
                                                    type='checkbox'
                                                    checked={selectedMarketSymbols.includes(market.symbol)}
                                                    onChange={e => {
                                                        if (e.target.checked) handleAddMarket(market.symbol);
                                                        else handleRemoveMarket(market.symbol);
                                                    }}
                                                    disabled={isRunning}
                                                />
                                                <span>
                            ...
                            <div className='auto-trades-card'>
                                ...
                                <div className='auto-trades-stats'>
                                    ...
                                    <div className='auto-trades-stats__row'>
                                        <span>P&amp;L</span>
                                        <strong
                                            className={classNames('auto-trades-stats__pnl', {
                                    ...
                                    <div className='auto-trades-stats__row'>
                                        ...
                                        <span
                                            className={classNames('auto-trades-stats__next-stake', {
                                    ...
                                    <div className='auto-trades-stats__row'>
                                        ...
                                        <span className='auto-trades-stats__limit auto-trades-stats__limit--tp'>
                                            +{takeProfit}
                                        </span>
                                    </div>
                                    <div className='auto-trades-stats__row'>
                                        <span>Stop Loss</span>
                                        <span className='auto-trades-stats__limit auto-trades-stats__limit--sl'>
                                            -{stopLoss}
                                        </span>
                                    </div>
                                </div>
                                ...
                                {!isRunning && isConnected && (
                                    <div className='auto-trades-hint'>
                                        Live data active. Press Run to start trading.
                                    </div>
                                )}

                                {isRecoveringData && (
                                    <div className='auto-trades-hint auto-trades-hint--recovery'>
                                        Market data paused. Reconnecting streams...
                                    </div>
                                )}

                                {!isConnected && !isRecoveringData && (
