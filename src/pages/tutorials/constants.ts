...
export const user_guide_content = (): TUserGuideContent[] => [
    {
        ...
        type: 'Tour',
        subtype: 'OnBoard',
        content: localize('Get started on Mr Chris'),
...
export const guide_content = (): TGuideContent[] => [
    {
        id: 1,
        type: 'DBotVideo',
        content: localize('An introduction to Mr Chris'),
    ...
    },
    {
        id: 2,
        type: 'DBotVideo',
        content: localize('How to build a basic trading bot with Mr Chris'),
    ...
    },
    {
        id: 3,
        type: 'DBotVideo',
        content: `${localize('How to use')} Martingale ${localize('strategy on Mr Chris')}`,
    ...
    },
    {
        id: 4,
        type: 'DBotVideo',
        content: `${localize('Introducing')} ${localizeAccumulators()} ${localize('Options on Mr Chris: Available for automated trading')}`,
...
export const faq_content = (): TFaqContent[] => [
    {
        title: localize('What is Mr Chris?'),
        description: [
            {
                type: 'text',
                content: localize(
                    "Mr Chris is a web-based strategy builder for trading digital options. It’s a platform where you can build your own automated trading bot using drag-and-drop 'blocks'."
                ),
            },
        ],
        search_id: 'faq-0',
    ...
    {
        title: localize('Do you offer pre-built trading bots on Mr Chris?'),
        description: [
            {
                type: 'text',
    ...
    },
    {
        ...
        description: [
            {
                type: 'text',
                content: `${localize('A quick strategy is a ready-made strategy that you can use in Mr Chris. There are 3 quick strategies you can choose from:')} Martingale, D'Alembert, ${localize('and')} Oscar's Grind.`,
            },
            {
                type: 'text',
    ...
    {
        title: localize('How do I import my own trading bot into Mr Chris?'),
        description: [
            {
                type: 'text',
                content: localize(
    ...
    {
        title: localize('How do I control my losses with Mr Chris?'),
        description: [
            {
                type: 'text',
                content: localize(
                    'There are several ways to control your losses with Mr Chris. Here’s a simple example of how you can implement loss control in your strategy:'
                ),
            },
            {
                type: 'image',
    ...
    {
        title: localize('Can I run Mr Chris on multiple tabs in my web browser?'),
        description: [
            {
                type: 'text',
                content: localize(
    ...
    {
        title: localize('Can I trade cryptocurrencies on Mr Chris?'),
        description: [
            {
                type: 'text',
                content: localize("No, we don't offer cryptocurrencies on Mr Chris."),
            },
        ],
        search_id: 'faq-12',
    },
        ...
        description: [
            {
                type: 'text',
                content: localize(
                    "No, we don't. However, you'll find quick strategies on Mr Chris that'll help you build your own trading bot for free."
                ),
            },
        ],
        search_id: 'faq-13',
    ...
    {
        title: localize('In which countries is Mr Chris available?'),
        description: [
            {
                type: 'text',
                content: localize(
    ...
    {
        title: localize('If I close my web browser, will Mr Chris continue to run?'),
        description: [
            {
                type: 'text',
                content: localize('No, Mr Chris will stop running when your web browser is closed.'),
            },
        ],
        search_id: 'faq-15',
    },
    {
        ...
        description: [
            {
                type: 'text',
                content: `${localize('Three of the most commonly used strategies in automated trading are')} Martingale, D'Alembert, ${localize('and')} Oscar's Grind — ${localize('you can find them all ready-made and waiting for you in Mr Chris.')}`,
            },
        ],
        search_id: 'faq-16',
    },
        ...
        description: [
            {
                type: 'text',
                content: localize(
                    '<a href="https://www.youtube.com/watch?v=QdI5zCkO4Gk&t=203s" target="_blank">Watch this video</a> to learn how to build a trading bot on Mr Chris. Also, <a href="https://deriv.com/academy/blog/posts/how-to-build-a-basic-trading-bot-with-dbot/" target="_blank">check out this blog post</a> on building a trading bot.'
                ),
            },
        ],
        search_id: 'faq-17',
...
export const quick_strategy_content = (): TQuickStrategyContent[] => [
    {
        ...
        content: [
            `${localize('Exploring the')} Martingale ${localize('strategy in Mr Chris')}`,
    ...
    },
    {
        ...
        content: [
            `${localize('Exploring the')} D'Alembert ${localize('strategy in Mr Chris')}`,
    ...
    },
    {
        ...
        content: [
            `${localize('Exploring the')} Oscar's Grind ${localize('strategy in Mr Chris')}`,
    ...
    },
    {
        ...
        content: [
            `${localize('Exploring the')} Reverse Martingale ${localize('strategy in Mr Chris')}`,
    ...
    },
    {
        ...
        content: [
            `${localize('Exploring the')} Reverse D'Alembert ${localize('strategy in Mr Chris')}`,
    ...
    },
    {
        ...
        content: [
            `${localize('Exploring the')} 1-3-2-6 ${localize('strategy in Mr Chris')}`,
