...
export const ANNOUNCEMENTS: Record<string, TAnnouncement> = {
    UPDATES_QUICK_STRATEGY_MODAL_ANNOUNCE: {
        announcement: {
            ...
            media: ['/assets/images/build_a_bot.png'],
            title: [
    ...
    MOVING_STRATEGIES_ANNOUNCE: {
        announcement: {
            ...
            main_title: localize('Moving strategies to Mr Chris'),
            ...
            numbered_content: [
                {
                    id: 0,
                    text: localize('Download your strategy in XML format and import it to Mr Chris.'),
                },
                {
                    id: 1,
            ...
            plain_text: [
                {
                    ...
                    text: (
                        <Localize
                            i18n_default_text='<0>Note</0>: Uploading complex strategies may take some time. Saving them from Mr Chris ensures quicker access later. If you have questions, contact us via <1/>.'
    ...
    BLOCKLY_ANNOUNCE: {
        announcement: {
            ...
            title: (
                <Localize
                    i18n_default_text='We have updated our Blockly system in Mr Chris from <0>version 3 to version 10</0>. This brings:'
                    components={[<strong key={0} />]}
                />
            ),
            numbered_content: [
    ...
    ACCUMULATOR_ANNOUNCE: {
        announcement: {
            ...
            main_title: `${localizeAccumulators()} ${localize('now on Mr Chris')}`,
        ...
        switch_tab_on_cancel: DBOT_TABS.BOT_BUILDER,
        switch_tab_on_confirm: DBOT_TABS.BOT_BUILDER,
...
export const BOT_ANNOUNCEMENTS_LIST: TAnnouncementItem[] = [
    ...
    },
    {
        id: 'MOVING_STRATEGIES_ANNOUNCE',
        icon: IconAnnounce,
        title: localize('Moving strategies to Mr Chris'),
    ...
    },
    {
        ...
        message: localize('We have updated our Blockly system in Mr Chris from version 3 to version 10.'),
    ...
    },
    {
        id: 'ACCUMULATOR_ANNOUNCE',
        icon: IconAnnounce,
        title: `${localizeAccumulators()} ${localize('is now on Mr Chris')}`,
